...
import DashboardDosenPA from '@/components/DashboardDosenPA';

export default function DosenPADashboardPage() {
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-3 bg-white/20 rounded w-28 animate-pulse" />
                </div>
              </div>

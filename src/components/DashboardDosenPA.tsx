  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="px-6 py-5 bg-card border-b border-border">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <p className="text-base font-bold text-foreground">{dosenData.nama}</p>
        ...
        <div className="bg-destructive/10 rounded-2xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center size-10 rounded-xl bg-destructive/20">
              <Icon icon="solar:clock-circle-bold" className="size-5 text-destructive" />
            </div>
            <div>
              <p className="text-sm font-semibold text-foreground">Pengajuan Pending</p>
              <p className="text-xs text-muted-foreground">Memerlukan verifikasi</p>
            </div>
          </div>
          <span className="text-2xl font-bold text-destructive">{stats.pending}</span>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-card rounded-2xl p-4 shadow-sm border border-border">
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <p className="text-2xl font-bold text-foreground">{stats.total_pengajuan}</p>
            ...
            <div className="bg-card rounded-2xl p-4 shadow-sm border border-border">
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <p className="text-2xl font-bold text-foreground">{stats.diverifikasi}</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <p className="text-base font-bold text-white">Verifikasi Kegiatan</p>
                      <p className="text-xs text-white/80">Verifikasi pengajuan mahasiswa</p>
                    </div>
                  </div>
                  <Icon icon="solar:alt-arrow-right-linear" className="size-6 text-white" />
                </div>
              </div>
            </button>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center size-12 rounded-xl bg-secondary/10">
                      <Icon icon="solar:users-group-rounded-bold" className="size-6 text-secondary" />
                    </div>
                    <div className="text-left">
                      <p className="text-sm font-semibold text-foreground">
                        Daftar Mahasiswa Bimbingan
                      </p>
                      <p className="text-xs text-muted-foreground">{stats.total_mahasiswa_bimbingan} mahasiswa aktif</p>
                    </div>
                  </div>
                  <Icon
              ...
              <div className="bg-card rounded-2xl p-5 shadow-sm border border-border">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <p className="text-sm font-semibold text-foreground">Rekap Poin Mahasiswa</p>
                      <p className="text-xs text-muted-foreground">Lihat statistik poin mahasiswa</p>
                    </div>
                  </div>
                  <Icon
                    icon="solar:alt-arrow-right-linear"
            ...
            >
              <div className="bg-card rounded-2xl p-5 shadow-sm border border-border">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center justify-center size-12 rounded-xl bg-primary/10">
                      <Icon icon="solar:history-bold" className="size-6 text-primary" />
                    </div>
                    <div className="text-left">
                      <p className="text-sm font-semibold text-foreground">Riwayat Verifikasi</p>
                      <p className="text-xs text-muted-foreground">Lihat riwayat verifikasi Anda</p>
                    </div>
                  </div>
                  <Icon
                    icon="solar:alt-arrow-right-linear"
        ...
        {/* Tips */}
        <div className="pb-6">
          <div className="bg-gradient-to-r from-accent/20 to-accent/10 rounded-2xl p-5 border border-accent/30">
            <div className="flex items-center gap-4">
              <div className="flex items-center justify-center size-14 rounded-xl bg-accent/30">
                <Icon icon="solar:info-circle-bold" className="size-7 text-accent-foreground" />
              </div>
              <div>
                <p className="text-sm font-semibold text-foreground">Tips Verifikasi</p>

...
export default function RekapitulasiPoinMusyrif() {
  ...
  const fetchRekapitulasi = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/musyrif/rekapitulasi');
      ...
      <div className="px-6 py-5 bg-primary border-b border-border">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-white font-heading">Rekapitulasi Poin</h1>
          </div>
        </div>
      </div>
